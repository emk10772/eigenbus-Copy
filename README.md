...
## How it works
The best way to learn how this library works is to dive into the code. The main file is eigen_comms.cpp. Use the following diagram as a guide to what is going on:
